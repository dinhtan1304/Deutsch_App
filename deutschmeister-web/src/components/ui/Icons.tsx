...
export function IconXCircle({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconHeadphones({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconSpellCheck({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconUserPlus({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconLogIn({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconEyeOff({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconLoader({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props} className={`animate-spin ${props.className ?? ''}`}>
...
export function IconCheckAll({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconKeyboard({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconPenTool({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconRocket({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconMedal({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconMicrophone({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconDiscord({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props} viewBox="0 0 24 24" fill="currentColor" stroke="none">
...
export function IconSparkles({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
