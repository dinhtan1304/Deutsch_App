      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black tracking-tight mb-0.5">Xếp hạng</h1>
              <p className="text-sm font-medium opacity-50">Đường đua vinh quang của các cao thủ</p>
            </div>
          </div>
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex p-1.5 rounded-full backdrop-blur-xl border"
            ...
            {Object.entries(PERIOD_LABELS).map(([key, label]) => (
              <button key={key} onClick={() => setPeriod(key as keyof typeof PERIOD_LABELS)}
              ...
              <div className="flex flex-col items-center">
                {top3[0] && (
                  <ProfileLink userId={top3[0].userId} selfId={user?.id} className="flex flex-col items-center max-w-full transition-transform hover:-translate-y-0.5">
                    ...
                    <div className="text-sm md:text-base font-black truncate max-w-full mb-1">{top3[0].name || 'Ẩn danh'}</div>
