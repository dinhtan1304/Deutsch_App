      ...
      <div className="py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <section>
              <h2 className="text-xs font-bold uppercase tracking-wider mb-3"
                style={{ color: 'var(--theme-text-muted)' }}>{t('stepWritingType')}</h2>
            ...
            <section>
              <h2 className="text-xs font-bold uppercase tracking-wider mb-3"
                style={{ color: 'var(--theme-text-muted)' }}>{t('stepWordCount')}</h2>
              <div className="flex gap-2">
            ...
            <div className="rounded-2xl border p-5"
              ...
              <div className="grid grid-cols-2 gap-y-2 text-body">
                ...
                <span style={{ color: 'var(--theme-text-muted)' }}>{t('summaryWritingType')}</span>
                <span className="font-semibold" style={{ color: 'var(--theme-text-primary)' }}>
                  {suggestions?.writingTypes.find(wt => wt.value === effectiveWritingType)?.labelVi || t('notSelected')}
                </span>
                <span style={{ color: 'var(--theme-text-muted)' }}>{t('summaryWordCount')}</span>
                <span className="font-semibold" style={{ color: 'var(--theme-text-primary)' }}>{wordCount?.label || t('noneDash')}</span>
              </div>
            </div>
