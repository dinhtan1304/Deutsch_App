      ...
      {inProgress ? (
        <section className="v2-hero-warn mb-6 flex flex-col gap-4 overflow-hidden rounded-2xl p-5 sm:flex-row sm:items-center"
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            ...
            <Link href="/practice-test/writing/new" className="v2-btn-soft inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-bold">
              {tHub('newCta')}
            </Link>
            <Link href="/practice-test/writing/exam" className="v2-btn-soft inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-medium">
              {tHub('examCta')}
            </Link>
          </div>
        </section>
