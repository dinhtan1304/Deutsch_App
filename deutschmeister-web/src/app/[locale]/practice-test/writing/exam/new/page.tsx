...
import { IconPenLine, IconChevronLeft, IconLoader, IconCheck } from '../../icons';
...
export default function ExamWritingNewPage() {
  ...
  return (
    <div className="mx-auto max-w-360 px-4 py-6 sm:px-6">
      <Link href="/practice-test/writing/exam" className="mb-4 inline-flex items-center gap-1 text-caption font-semibold transition-opacity hover:opacity-70" style={{ color: 'var(--accent)' }}>
          ...
          <div className="overflow-hidden rounded-2xl border" style={{ background: 'var(--theme-bg-card)', borderColor: 'var(--theme-border)', boxShadow: 'var(--v2-shadow-card-hover)' }}>
            <div className="px-4 py-4" style={{ borderBottom: '1px solid var(--theme-border)', background: 'color-mix(in srgb, var(--accent) 8%, transparent)' }}>
              <div className="mb-1.5 flex items-center gap-2">
                <IconPenLine size={16} style={{ color: 'var(--accent)' }} />
