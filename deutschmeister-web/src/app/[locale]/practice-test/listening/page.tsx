      ...
      {inProgress ? (
        <section className="v2-hero-warn mb-6 flex flex-col gap-4 overflow-hidden rounded-2xl p-5 sm:flex-row sm:items-center"
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            ...
            <Link href="/practice-test/listening/new" className="inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-bold" style={{ background: 'var(--theme-bg-card)', color: 'var(--theme-text-secondary)', border: '1px solid var(--theme-border)' }}>
              {tHub('newCta')}
            </Link>
            <Link href="/practice-test/listening/exam" className="inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-medium" style={{ background: 'transparent', color: 'var(--theme-text-muted)', border: '1px solid var(--theme-border)' }}>
              {tHub('examCta')}
            </Link>
          </div>
        </section>
