      ...
      {inProgress ? (
        <section className="v2-hero-warn mb-6 flex flex-col gap-4 overflow-hidden rounded-2xl p-5 sm:flex-row sm:items-center"
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            <Link href={`/practice-test/listening/${inProgress.id}`} className="inline-flex h-10 items-center gap-1.5 rounded-[10px] px-4 text-caption font-bold text-white transition-transform hover:-translate-y-0.5" style={{ background: 'var(--warn)', boxShadow: '0 4px 14px color-mix(in srgb, var(--warn) 40%, transparent)' }}>
              {tHub('heroContinueCta')} <IconArrowRight size={14} />
            </Link>
            <Link href="/practice-test/listening/new" className="v2-btn-soft inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-bold" style={{ background: 'var(--theme-bg-card)', color: 'var(--theme-text-secondary)', border: '1px solid var(--theme-border)' }}>
              {tHub('newCta')}
            </Link>
            <Link href="/practice-test/listening/exam" className="v2-btn-soft inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-medium" style={{ background: 'transparent', color: 'var(--theme-text-muted)', border: '1px solid var(--theme-border)' }}>
              {tHub('examCta')}
            </Link>
          </div>
        </section>
        ...
        <section className="v2-hero-accent mb-6 flex flex-col items-start gap-4 overflow-hidden rounded-2xl p-5 sm:flex-row sm:items-center"
          ...
          <div className="flex shrink-0 gap-2">
            ...
            <Link href="/practice-test/listening/exam" className="v2-btn-soft inline-flex h-10 items-center rounded-[10px] px-4 text-caption font-medium" style={{ background: 'var(--theme-bg-card)', color: 'var(--theme-text-secondary)', border: '1px solid var(--theme-border)' }}>
              {tHub('examCta')}
            </Link>
          </div>
        </section>
