      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          ...
          <div>
            ...
            <ul style={ulStyle}>
              <li style={liStyle}>{t('s2_1l1')}</li>
              <li style={liStyle}>{t('s2_1l2')}</li>
              <li style={liStyle}>{t('s2_1l3')}</li>
              <li style={liStyle}>{t('s2_1l4')}</li>
            </ul>

            <h3 style={h3Style}>{t('s2_2Title')}</h3>
            <ul style={ulStyle}>
              <li style={liStyle}>{t('s2_2l1')}</li>
              <li style={liStyle}>{t('s2_2l2')}</li>
              <li style={liStyle}>{t('s2_2l3')}</li>
            </ul>

            <h3 style={h3Style}>{t('s2_3Title')}</h3>
            <p style={pStyle}>{t.rich('s2_3p', richB)}</p>

            <h3 style={h3Style}>{t('s2_4Title')}</h3>
            <ul style={ulStyle}>
              <li style={liStyle}>{t('s2_4l1')}</li>
              <li style={liStyle}>{t('s2_4l2')}</li>
              <li style={liStyle}>{t('s2_4l3')}</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={ulStyle}>
              <li style={liStyle}>{t('s3l1')}</li>
              <li style={liStyle}>{t('s3l2')}</li>
              <li style={liStyle}>{t('s3l3')}</li>
              <li style={liStyle}>{t('s3l4')}</li>
            </ul>
            <p style={pStyle}>{t.rich('s3p', richB)}</p>
          </div>
          ...
          <div>
            ...
            <ul style={ulStyle}>
              ...
              <li style={liStyle}>{t('s5l4')}</li>
              <li style={liStyle}>{t('s5l5')}</li>
            </ul>
          </div>

          <div>
            <h2 style={h2Style}>{t('s6Title')}</h2>
            <p style={pStyle}>{t('s6p')}</p>
            <ul style={ulStyle}>
              <li style={liStyle}><strong>{t('s6l1View')}</strong> {t('s6l1Body')}</li>
              <li style={liStyle}><strong>{t('s6l2Edit')}</strong> {t('s6l2Body')}</li>
              <li style={liStyle}><strong>{t('s6l3Delete')}</strong> {t('s6l3Body')}</li>
              <li style={liStyle}><strong>{t('s6l4Export')}</strong> {t('s6l4Body')}</li>
              <li style={liStyle}><strong>{t('s6l5Unsub')}</strong> {t('s6l5Body')}</li>
            </ul>
          </div>

          <div>
            <h2 style={h2Style}>{t('s7Title')}</h2>
            <p style={pStyle}>{t('s7p')}</p>
          </div>

          <div>
            <h2 style={h2Style}>{t('s8Title')}</h2>
            <p style={pStyle}>{t('s8p')}</p>
          </div>
