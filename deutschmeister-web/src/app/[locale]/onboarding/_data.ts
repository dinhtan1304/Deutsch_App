...
// labelKey / subKey resolve via i18n in components (see StepGoal, StepResult, etc.)
export const GOALS = [
  { value: 10, labelKey: 'label10' as const, subKey: 'sub10' as const },
  { value: 20, labelKey: 'label20' as const, subKey: 'sub20' as const },
  { value: 30, labelKey: 'label30' as const, subKey: 'sub30' as const },
] as const;

export const LEVEL_CONFIG = {
  A1: { color: STATUS.success, labelKey: 'levelA1' as const },
  A2: { color: ACCENT.srs, labelKey: 'levelA2' as const },
  B1: { color: ACCENT.vocab, labelKey: 'levelB1' as const },
};
