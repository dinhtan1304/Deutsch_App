      ...
      <div className="flex items-start justify-between gap-3 mb-6">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-xs font-bold" style={{ color: 'var(--theme-text-muted)' }}>
            <span className="flex items-center gap-1"><IconClock size={11} /> ~{readingMin} phút đọc</span>
            <span className="opacity-40">·</span>
            <span>{wordCount} từ</span>
            <span className="opacity-40">·</span>
            <span>{answered}/{questions.length} câu đã làm</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center gap-4 w-full">
          <div className="flex-1 flex items-center gap-3">
            ...
            <span className="text-xs font-black uppercase tracking-widest opacity-40">
              Tiến độ: {answered}/{questions.length}
            </span>
          </div>
