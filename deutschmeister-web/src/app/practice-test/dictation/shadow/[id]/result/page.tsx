...
function getScoreLabel(score: number) {
  if (score >= 90) return { label: 'Tuyệt vời', emoji: '🌟' };
  if (score >= 75) return { label: 'Rất tốt', emoji: '✨' };
  if (score >= 60) return { label: 'Khá tốt', emoji: '👍' };
  if (score >= 40) return { label: 'Cần cố gắng', emoji: '💪' };
  return { label: 'Tiếp tục luyện', emoji: '🔄' };
}
...
export default function ShadowingResultPage() {
  ...
  const meta = getScoreLabel(overall);
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 pb-32">
      ...
      >
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          >
            Bạn đã luyện {session.completedSegments} / {session.totalSegments} câu
            trong video này.
          </p>
          <div className="flex flex-wrap gap-3 justify-center md:justify-start">
            ...
            >
              {startMut.isPending ? 'Đang tạo...' : '🔄 Luyện lại video này'}
            </button>
            <Link
          ...
          return (
            ...
            >
              ...
              {a.userTranscript && (
                ...
                >
                  Bạn đã nói: &ldquo;{a.userTranscript}&rdquo;
                </div>
              )}
              {a.feedback && (
                <div
