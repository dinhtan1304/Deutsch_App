  ...
  return (
    <div className="py-6">
      ...
      <div className="flex items-center gap-2 mb-6">
        <Link href="/practice-test/writing/exam" className="flex items-center gap-1 text-[13px] font-medium transition-opacity hover:opacity-70"
      ...
      <p className="text-[13px] mb-6" style={{ color: 'var(--theme-text-muted)' }}>
        Chọn loại đề và trình độ để AI tạo bài thi đầy đủ các Teil
      </p>
      ...
      {examInfo && !isTelcA1 && (
        <div className="rounded-2xl border p-4 mb-6"
          ...
          <p className="text-[13px] font-bold mb-2" style={{ color: '#A855F7' }}>
      ...
      {generateMut.isPending && (
        <p className="text-center text-[12px] mt-3" style={{ color: 'var(--theme-text-muted)' }}>
          AI đang tạo các tình huống viết...
        </p>
      )}
    </div>
  );
