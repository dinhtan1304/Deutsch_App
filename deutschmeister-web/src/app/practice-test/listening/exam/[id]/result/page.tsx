...
import { ExamListeningTeil, TeilScore, TeilGradingDetail, ExamListeningQuestion } from '@/lib/api/examListening';
    ...
    <div className="min-h-screen pb-24" style={{ backgroundColor: 'var(--theme-bg-primary)' }}>
      ...
      <div className="sticky top-0 z-10 border-b" style={{ backgroundColor: 'var(--theme-bg-card)', borderColor: 'var(--theme-border)' }}>
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <p className="text-[13px] font-bold" style={{ color: 'var(--theme-text-primary)' }}>
            {session.examType} {session.cefrLevel} · Hören · Ergebnis
          </p>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6 space-y-5">
                ...
                return (
                  <div key={ts.teil}>
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[12px] font-bold" style={{ color: pct >= 60 ? '#22C55E' : '#EF4444' }}>
                        {Math.round(pct)}%
                      </span>
                    </div>
        ...
        <div className="rounded-2xl border p-4 flex items-center gap-4"
          style={{ borderColor: passed ? 'rgba(236,72,153,.3)' : 'rgba(239,68,68,.2)', backgroundColor: passed ? 'rgba(236,72,153,.04)' : 'rgba(239,68,68,.04)' }}>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        {ts && (
                          <p className="text-[12px]" style={{ color: pct >= 60 ? '#22C55E' : '#EF4444' }}>
