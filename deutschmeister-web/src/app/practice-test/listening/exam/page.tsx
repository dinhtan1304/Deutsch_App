...
export default function ExamListeningListPage() {
  ...
  const { data: history, isLoading } = useExamListeningHistory(params);
    ...
    <div className="py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <Link href="/practice-test/listening/exam/new"
          ...
          style={{ background: GRADIENT, boxShadow: '0 4px 12px rgba(236,72,153,.25)' }}>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: 'var(--theme-text-primary)' }}>Luyện Nghe Theo Đề Chuẩn</h1>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-[14px] mb-4" style={{ color: 'var(--theme-text-muted)' }}>Chưa có bài nghe theo đề nào.</p>
          <Link href="/practice-test/listening/exam/new"
