    ...
    <div className="max-w-5xl mx-auto px-4 py-8 pb-32">
      ...
      {stats && stats.total > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {[
            { label: 'Tổng bài thi', value: stats.total, color: ACCENT.listening, icon: <IconHeadphones size={20} /> },
      ...
      {isLoading ? (
        ...
        <div className="text-center py-28 rounded-[3.5rem] border-2 border-dashed" style={{ borderColor: 'var(--theme-border)' }}>
          ...
          <p className="text-base opacity-50 mb-10 max-w-xs mx-auto font-medium">Bắt đầu làm bài luyện nghe theo đề chuẩn Goethe/TELC ngay nhé!</p>
          <Link href="/practice-test/listening/exam/new"
