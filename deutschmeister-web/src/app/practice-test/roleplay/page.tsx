    ...
    >
      ...
      <section className="mb-16">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-black tracking-tight" style={{ color: 'var(--theme-text-primary)' }}>Tình huống luyện tập</h2>
        </div>
      ...
      {confirmDeleteId && (
        <div className="mb-10 rounded-[2.5rem] border-2 p-8 flex items-center justify-between gap-8 flex-wrap animate-in fade-in slide-in-from-top-4 duration-500"
          ...
          <div>
            <h4 className="text-xl font-black mb-1.5" style={{ color: 'var(--theme-text-primary)' }}>Xóa hội thoại?</h4>
            <p className="text-base opacity-50 font-medium" style={{ color: 'var(--theme-text-primary)' }}>Lịch sử trò chuyện này sẽ bị gỡ bỏ vĩnh viễn.</p>
          </div>
      ...
      {history && history.data.length > 0 && (
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-black tracking-tight" style={{ color: 'var(--theme-text-primary)' }}>Lịch sử gần đây</h2>
          </div>
