      ...
      <div className="py-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-11 h-11 rounded-2xl flex items-center justify-center"
            style={{ background: 'linear-gradient(135deg, #F59E0B, #F97316)' }}>
            <IconStar size={22} style={{ color: 'white' }} />
          </div>
          <div>
            <h1 className="text-2xl font-bold" style={{ color: 'var(--theme-text-primary)' }}>Từ vựng yêu thích</h1>
        ...
        {/* Error */}
        {error && (
          <div className="text-center py-12 text-[14px]" style={{ color: '#EF4444' }}>Lỗi tải dữ liệu. Vui lòng thử lại.</div>
        )}
