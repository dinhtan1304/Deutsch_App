      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '36px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '16px 20px', borderRadius: '16px', background: cardBg, border: `1px solid ${borderColor}` }}>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ color: 'white', fontSize: '16px', fontWeight: 600 }}>{detectedLevel} — {lc.label}</div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '16px 20px', borderRadius: '16px', background: cardBg, border: `1px solid ${borderColor}` }}>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ color: 'white', fontSize: '16px', fontWeight: 600 }}>{dailyGoal ?? '---'} từ / ngày</div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '16px 20px', borderRadius: '16px', background: cardBg, border: `1px solid ${borderColor}` }}>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ color: 'white', fontSize: '16px', fontWeight: 600 }}>{scores.total}/{totalQuestions} câu đúng</div>
          </div>
        </div>
      </div>
