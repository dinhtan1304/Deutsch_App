...
export const GenderInfo = {
  masculine: { article: 'der', color: '#3B82F6', bgColor: 'rgba(59, 130, 246, 0.1)', label: 'Maskulin' },
  feminine: { article: 'die', color: '#EC4899', bgColor: 'rgba(236, 72, 153, 0.1)', label: 'Feminin' },
  neuter: { article: 'das', color: '#10B981', bgColor: 'rgba(16, 185, 129, 0.1)', label: 'Neutrum' },
} as const;
