/**
 * Listening Comprehension API Client (Mobile)
 *
 * Endpoints:
 * - POST   /listening/generate        -> AI generate listening session
 * - POST   /listening/:id/submit      -> Submit answers + grade
 * - GET    /listening/:id             -> Session detail
 * - GET    /listening/history         -> History
 * - GET    /listening/stats           -> Stats
 * - DELETE /listening/:id             -> Delete
 */
