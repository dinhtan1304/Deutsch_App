...
export default function ListeningScreen() {
  ...
  const bgColor = bgFlash.interpolate({
    inputRange: [0, 1],
    outputRange: ['rgba(20, 184, 166, 0)', 'rgba(20, 184, 166, 0.15)'],
  });
      ...
      <SafeAreaView className="flex-1 bg-dark-bg">
        <View className="flex-1 items-center justify-center px-6">
          ...
          >
            ...
            <Text className="mt-1 text-white/70">Listening hoàn thành</Text>
          </LinearGradient>
      ...
      <Animated.View className="flex-1" style={{ backgroundColor: bgColor }}>
        ...
        <View className="mx-4 mt-6 items-center">
          <View className="items-center rounded-2xl bg-dark-card p-8">
            <Text className="mb-4 text-sm text-gray-400">Nghe và chọn từ đúng</Text>
            ...
            <Animated.View style={{ transform: [{ scale: speakerPulse }] }}>
              <TouchableOpacity
                ...
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  backgroundColor: isSpeaking ? 'rgba(20, 184, 166, 0.3)' : 'rgba(20, 184, 166, 0.15)',
                  borderWidth: 2,
                  borderColor: '#14B8A6',
                }}
              >
            ...
            <TouchableOpacity
              ...
              disabled={isSpeaking || selectedAnswer !== null}
              className="mt-4 flex-row items-center rounded-lg bg-dark-secondary px-4 py-2"
            >
              <Ionicons name="play-outline" size={16} color="#9CA3AF" />
              <Text className="ml-1 text-xs text-gray-400">Nghe chậm</Text>
            </TouchableOpacity>

            {playCount > 0 && (
              <Text className="mt-2 text-xs text-gray-500">Đã nghe {playCount} lần</Text>
            )}
        ...
        <Animated.View
          className="mx-4 mt-6"
          style={{ transform: [{ translateX: shakeAnim }], gap: 10 }}
        >
